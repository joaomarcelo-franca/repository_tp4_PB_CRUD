...
class ProductServiceUnitTest {
    ...
    void testCreateProductValid() {
        ...
        assertNotNull(p, "Produto criado não deveria ser nulo");
        assertEquals("Produto A", p.getName(), "Nome do produto deve ser idêntico ao informado");
    }
    ...
    public void testCreateProductWithoutImageThrows() {
        assertThrows(IllegalArgumentException.class, () ->
                ...
                "Criar produto sem imagem deve lançar IllegalArgumentException"
        );
    }
